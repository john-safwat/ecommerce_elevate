...
import 'package:ecommerce_elevate/data/datasource/impl/categories_remote_datasource_impl.dart';
...
void main() async {
  ...
  group("Categories Remote Datasource", () {
    ...
    test("API call takes an extended time.", () async {
      ...
      expect(actualResult, result);
      expect(
        ((actualResult as Failure<List<Category>?>).exception as DioException)
            .type,
