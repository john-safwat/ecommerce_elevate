...
class _AddressesRetrofitClient implements AddressesRetrofitClient {
  ...
  Future<RemoveAddressResponseDto> removeAddress(
    ...
    final _options = _setStreamType<RemoveAddressResponseDto>(Options(
      method: 'DELETE',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late RemoveAddressResponseDto _value;
    try {
      _value = RemoveAddressResponseDto.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
