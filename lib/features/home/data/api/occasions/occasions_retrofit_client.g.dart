...
part of 'occasions_retrofit_client.dart';
...
class _OccasionsRetrofitClient implements OccasionsRetrofitClient {
  _OccasionsRetrofitClient(
    this._dio, {
    this.baseUrl,
    this.errorLogger,
  }) {
  ...
  @override
  Future<OccasionsResponseDto> getOccasionsList() async {
