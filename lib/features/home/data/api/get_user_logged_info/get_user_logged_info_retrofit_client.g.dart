...
part of 'get_user_logged_info_retrofit_client.dart';
...
class _GetUserLoggedInfoRetrofitClient
    implements GetUserLoggedInfoRetrofitClient {
  ...
  @override
  Future<ProfileResponseDto> getLoggedUserInfo({String? token}) async {
