...
part of 'logout_retrofit_client.dart';
...
class _LogoutRetrofitClient implements LogoutRetrofitClient {
  _LogoutRetrofitClient(
    this._dio, {
    this.baseUrl,
    this.errorLogger,
  }) {
  ...
  @override
  Future<LogoutResponseDto> logoutUser({String? token}) async {
