...
import 'package:ecommerce_elevate/features/edit_profile/widgets/user_form.dart';
...
class _ProfileViewState extends BaseState<ProfileView, ProfileViewModel> {
  late LoggedUser userData;

  @override
  didChangeDependencies() {
    super.didChangeDependencies();
    userData = ModalRoute.of(context)!.settings.arguments as LoggedUser;
    viewModel.doIntent(LoadDataAction(user: userData));
  }
        ...
        body: BlocConsumer<ProfileViewModel, ProfileViewState>(
          ...
          builder: (context, state) {
            if (state is ProfileDataLoadingState) {
              ...
              return SafeArea(child: UserForm(viewModel));
            }
          },
        ),
      ),
